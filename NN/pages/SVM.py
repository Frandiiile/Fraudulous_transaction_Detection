...
loaded_model = pickle.load(open('classifier4.pkl','rb'))
...
def main():
    ...
    st.write("Support Vector Machines (SVMs) are supervised learning models used for classification and regression tasks that attempt to find the best boundary between classes of data.")
